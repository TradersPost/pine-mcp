...
Pine Script® is TradingView’s programming
...
community of Pine Script programmers has published more than 150,000 Community Scripts, half of which are open-source.
Requirements
It’s our explicit goal to keep Pine Script accessible and easy to understand
...
requested from additional symbols, execution time, memory usage and script size.          Next   First steps